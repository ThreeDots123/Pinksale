export default function CreateDutchAuctionSteps() {
    return <div className="flex w-full justify-between max-lg:hidden">
        ...
        <div className="flex gap-3">
            ...
            <div>
                <div>
                    <h5 className="text-[--fade-text-color] font-medium mb-0.5 leading-8">Dutch Auction</h5>
                </div>
                <p className="text-sm max-w-36 text-[--fade-text-color]">
                    Enter the dutch auction information that you want to raise , that should be enter all details about your presale
                </p>
            </div>
        </div>
